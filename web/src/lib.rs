...
///
/// 1. Determine the environment the application is running in (see [`todoapp_graphql_config::get_env`])
/// 2. Load the configuration (see [`todoapp_graphql_config::load_config`])
